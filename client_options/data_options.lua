return {
    ...
    showLootOnScreen = {
        ...
        action = function(value, options, controller, panels, extraWidgets)
            if modules.loot_stats then
                modules.loot_stats.setShowLootOnScreen(value)
            end
        end
    },
    amountLootOnScreen = {
    ...
    ignoreMonsterLevelSystem = {
        value = false,
        action = function(value, options, controller, panels, extraWidgets)
            if modules.loot_stats then
                modules.loot_stats.setIgnoreMonsterLevelSystem(value)
            end
        end
    },
    ignoreLastSignWhenDot = {
        value = false,
        action = function(value, options, controller, panels, extraWidgets)
            if modules.loot_stats then
                modules.loot_stats.setIgnoreLastSignWhenDot(value)
            end
        end
    },
    fullscreen                        = {
    ...
    showLootOnScreen = {
        ...
        action = function(value) 
            -- Can be connected to loot stats module
        end
    },
    amountLootOnScreen = {
        value = 5,
